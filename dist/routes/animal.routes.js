...
router.post("/animal", authMiddleware_1.authMiddleware, animal_controller_1.createAnimal);
router.put("/animal/:id", authMiddleware_1.authMiddleware, animal_controller_1.updateAnimal);
